...
async function triggerRender(countryIdx) {
  // const data = await loadData(countryIdx);
  // render(data);
  return loadData(countryIdx).then(data => {
    console.log("promise return val", data);
    render(data);
  });
}
